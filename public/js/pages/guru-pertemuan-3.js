$(function () {
    ...
    var table_video = $('#table-video-3').DataTable({
        ajax: '/teacher/meeting/video/'+$('#table-video-3').data('id'),
        searching: false,
        ordering: false,
        paging: false,
        columnDefs: [
    ...
    var table_module = $('#table-module-3').DataTable({
        ajax: '/teacher/meeting/module/'+$('#table-module-3').data('id'),
        searching: false,
        ordering: false,
        paging: false,
        columnDefs: [
    ...
    var table_task = $('#table-task-3').DataTable({
        ajax: '/teacher/meeting/task/'+$('#table-task-3').data('id'),
        searching: false,
        ordering: false,
        paging: false,
        columnDefs: [
    ...
    var table_assignment = $('#table-assignment-3').DataTable({
        ajax: '/teacher/meeting/assignment/'+$('#table-assignment-3').data('id'),
        searching: false,
        ordering: false,
        paging: false,
        columnDefs: [
    ...
    var task_result = $('#table-task-result-3').DataTable({
        ajax: '/teacher/meeting/answer/'+$('#table-task-result-3').data('id'),
        searching: false,
        ordering: false,
        paging: false,
        columnDefs: [
    ...
    $('.btn-video-tambah').on('click', function (e) {
        e.preventDefault()
        // var meeting_id = $('#table-video-3').data('id');
        // $('#video_meeting_id').val(meeting_id);
        $("#modalVideo").modal('show');
    });

    // Button delete video
    $('#table-video-3 tbody').on('click', '.btn-delete', function () {
    ...
    $('.btn-module-tambah').on('click', function (e) {
        e.preventDefault()
        // var meeting_id = $('#table-module-3').data('id');
        // $('#module_meeting_id').val(meeting_id);
        $("#modalModule").modal('show');
    });

    // Button delete module
    $('#table-module-3 tbody').on('click', '.btn-delete', function () {
    ...
    $('.btn-task-tambah').on('click', function (e) {
        e.preventDefault()
        // var meeting_id = $('#table-task-3').data('id');
        // $('#task_meeting_id').val(meeting_id);
        $("#modalTask").modal('show');
    });

    // Button delete task
    $('#table-task-3 tbody').on('click', '.btn-delete', function () {
    ...
    $('.btn-assignment-tambah').on('click', function (e) {
        e.preventDefault()
        // var meeting_id = $('#table-assignment-3').data('id');
        // $('#assignment_meeting_id').val(meeting_id);
        $("#modalAssignment").modal('show');
    });

    // Button delete assignment
    $('#table-assignment-3 tbody').on('click', '.btn-delete', function () {
