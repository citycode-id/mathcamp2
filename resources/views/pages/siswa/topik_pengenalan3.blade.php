            ...
            <div class="card flex-fill">
                <div class="card-body" style="height: 32vw">
                    ...
                    <div id="start" style="min-height: 50px">
                        <button type="button" class="btn btn-light m-2 1">{{ __("L= L alas+ jumlah L sisitegak") }}</button>
                        <button type="button" class="btn btn-light m-2 2">{{ __("L=2x Luas alas + keliling alas x tinggi") }}</button>
                        <img src="{{ asset('img/materi/piramida.jpg') }}" class="img-thumbnail 1" alt="piramida" width="200">
                        <img src="{{ asset('img/materi/toblerone.jpg') }}" class="img-thumbnail 2" alt="toblerone" width="150">
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    <script src="{{asset('js/pages/siswa-topik-pengenalan3.js')}}"></script>
