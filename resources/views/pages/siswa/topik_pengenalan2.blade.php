            ...
            <div class="card flex-fill">
                <div class="card-body" style="height: 32vw">
                    ...
                    <div id="start" style="min-height: 50px">
                        <button type="button" class="btn btn-light m-2 1">{{ __("Luas permukaan = 2 [(p x l) + (p x t) + (l x t)]") }}</button>
                        <button type="button" class="btn btn-light m-2 2">{{ __("Luas permukaan = 6s^2") }}</button>
                        <img src="{{ asset('img/materi/penghapus.jpg') }}" class="img-thumbnail 1" alt="penghapus" width="200">
                        <img src="{{ asset('img/materi/dadu.png') }}" class="img-thumbnail 2" alt="dadu" width="150">
                    </div>
                </div>
            </div>
        </div>
